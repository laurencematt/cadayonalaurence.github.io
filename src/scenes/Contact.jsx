    ...
    <section id="contact" className="contact py-48">
      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          ...
          >
            <input
              className="w-full bg-white font-semibold text-deep-blue placeholder-opaque-black p-3"
              type="text"
              placeholder="Name"
              {...register("name", {
                required: true,
            ...
            <input
              className="w-full bg-white font-semibold text-deep-blue placeholder-opaque-black p-3 mt-5"
              type="text"
              placeholder="Email"
              {...register("email", {
                required: true,
